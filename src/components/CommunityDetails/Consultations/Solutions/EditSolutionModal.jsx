...
function EditSolutionModal({ isOpen, onClose, solution, onSubmit })
{
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
            <div className="relative w-[550px] max-h-[95vh] flex flex-col bg-white rounded-xl shadow-2xl">
