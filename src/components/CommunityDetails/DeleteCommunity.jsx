...
function DeleteCommunity({ community })
{
    ...
    return (
        <div className=" text-center">
            <button onClick={handleDelete} className="focus:outline-none min-w-[200px] sm:w-auto text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base px-3 py-2.5  ">
