...
function Filters()
{
    ...
    return (
        <>
            <div className="flex flex-col items-center md:flex-row md:justify-center md:items-end space-y-4 md:space-y-0 md:space-x-4 mb-4">


                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-4 w-full md:w-auto">
