...
function ProfileSettings({ user })
{
    return (<div className="flex flex-col w-full">
        <div className="lg:w-4/5 flex flex-col items-center lg:items-stretch justify-center p-2 py-4">
            ...
            <div className="flex flex-col gap-y-1 px-4 ">
                <div>
                    <p className='text-xl w-3/4'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6 inline-block mb-1">
